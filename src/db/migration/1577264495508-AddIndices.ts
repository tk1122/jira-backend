...
export class AddIndices1577264495508 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.dropIndex('game_transaction', 'unique_idx_game_transaction_game_transaction_id_game_round');
    await queryRunner.dropIndex('game_transaction', 'idx_game_transaction_round_end');
    await queryRunner.dropIndex('game_transaction', 'idx_game_transaction_is_rollback');
    await queryRunner.dropIndex('game_transaction', 'fk_game_transaction_game_session_id');
  }
}
